...
if(backBtn) {
  backBtn.onclick = (e) => {
    e.preventDefault();
    if (window.parent && window.parent !== window) { window.parent.postMessage('close-chat', '*'); } 
    else { window.location.href = 'index.html'; } // Or wherever you want the back button to go
  };
}
